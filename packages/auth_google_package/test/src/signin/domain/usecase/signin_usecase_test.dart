import 'package:auth_google_package/src/features/signin/domain/usecase/signin_usecase.dart';
...
void main() {
  ...
  test('Deve retornar um sucesso com bool', () async {
    ...
    final result = await usecase(
      parameters: ParametrosSignIn(
        error: ErroSignIn(
          message: "Erro ao fazer o signin",
        ),
        nameFeature: "Signin",
  ...
  test('Deve retornar um ErroSignIn - Erro ao fazer o signin', () async {
  ...
  test('Deve retornar ErroSignIn - Exeption', () async {
